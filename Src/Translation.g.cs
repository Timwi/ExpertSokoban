...
namespace ExpertSokoban
{
    ...
    {
        [LingoAutoGenerated, LingoNotes("Title bar.")]
        public TrString AboutBox = "About Expert Sokoban";

        [LingoAutoGenerated, LingoNotes("This is displayed in a box in the About dialog. Please feel free to add a line to credit yourself for your translation work.")]
    ...
    {
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.General), LingoNotes("Main window title bar.")]
        public TrString Mainform = "Expert Sokoban";

        [LingoAutoGenerated, LingoInGroup(TranslationGroup.Accessibility), LingoNotes("Describes the main menu bar.")]
        public TrString mnuMain = "Main menu";

        [LingoAutoGenerated, LingoInGroup(TranslationGroup.LevelMenu)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.EditMenu)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.OptionsMenu)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.HelpMenu)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.StatusBar)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.Accessibility), LingoNotes("Describes the toolbar which contains commands for editing a level.")]
        public TrString toolEditLevel = "Level edit toolbar";

        [LingoAutoGenerated, LingoInGroup(TranslationGroup.ToolEditLevel)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.Accessibility), LingoNotes("Describes the toolbar which contains commands for editing a level file.")]
        public TrString toolFileEdit = "File edit toolbar";

        [LingoAutoGenerated, LingoInGroup(TranslationGroup.ToolFileEdit)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.Accessibility), LingoNotes("Describes the toolbar which contains commands for handling level files.")]
        public TrString toolFile = "File toolbar";

        [LingoAutoGenerated, LingoInGroup(TranslationGroup.ToolFile)]
        ...
        [LingoAutoGenerated, LingoInGroup(TranslationGroup.Accessibility), LingoNotes("Describes the toolbar which contains commands for playing the game.")]
        public TrString toolPlay = "Playing toolbar";

        [LingoAutoGenerated, LingoInGroup(TranslationGroup.ToolPlay)]
