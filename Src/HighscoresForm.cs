...
namespace ExpertSokoban
{
    public partial class HighscoresForm : ManagedForm
    {
        ...
        {
            InitializeComponent();
            Lingo.TranslateControl(this, Program.Translation.Highscores);
        }
        ...
        public void SetContents(Dictionary<string, Highscore> highscores, SokobanLevel level)
        {
            ...
            for (int i = 0; i < playerNames.Count; i++)
            {
                ...
                lblScore.Text = Program.Translation.Highscores.Highscores.Fmt(h.BestPushScore.Pushes, h.BestPushScore.Moves);
