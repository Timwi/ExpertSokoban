...
public class BSPushFinder implements Thread
{
    ...
    private BSPackedBooleans extracted;
    ...
    private BSMoveFinder initialMoveFinder;
    ...
    class SpecialHeap
    {
        ...
        */
        ...
        public void add (int i)
        {
            ...
            element [ numElements ] = new ThreeIntegers (i, pushLength[i], moveLength[i]);
            numElements++;
    ...
    public BSPushFinder (SokobanLevel l, int x, int y, BSMainArea parentMa, BSMoveFinder curMF)
    {
        level = l;
        selX = x;
        selY = y;
        ...
        predefinedPaths = new int[][][][]
        {
            // from direction 0 ...
            {
                ...
                null,
                // to direction 1...
                { { -1, sx }, { 1, sx, sx, -1, -1, -sx }, { -sx, -1, -1, sx, sx, 1 } },
                // to direction 2...
                { { 1, sx }, { -1, sx, sx, 1, 1, -sx }, { -sx, 1, 1, sx, sx, -1 } },
                // to direction 3...
                { { -1, sx, sx, 1 }, { 1, sx, sx, -1} }
            ...
            {
                // to direction 0...
                { { -sx, 1 }, { sx, 1, 1, -sx, -sx, -1 }, { -1, -sx, -sx, 1, 1, sx } },
                // to direction 1...
                null,
                // to direction 2...
                { { -sx, 1, 1, sx }, { sx, 1, 1, -sx } },
        ...
        for (int consider_direction = 0; consider_direction < 4 && !stop; consider_direction++)
        {
            if (consider_direction != direction)
            {
                ...
                if (level.isFree (consider_spot))
                {
                    ...
                    {
                        BSMoveFinder mf = new BSMoveFinder (level, ma, true, position);
                        mf.run();
    ...
    public boolean pushValid (int pos, int posInDir) { return pushLength[4*pos+posInDir] > 0; }
    public boolean pushValid (int pos)
    {
